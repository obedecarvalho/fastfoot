...
public class ParametroConstantes {
	...
	public static final String MARCAR_AMISTOSOS_AUTOMATICAMENTE_INICIO_TEMPORADA_PARAM = "MARCAR_AMISTOSOS_INICIO_TEMPORADA";
	
	public static final String MARCAR_AMISTOSOS_AUTOMATICAMENTE_SEMANA_A_SEMANA_PARAM = "MARCAR_AMISTOSOS_SEMANA_A_SEMANA";
	
	public static final String MARCAR_AMISTOSOS_AUTOMATICAMENTE_INICIO_TEMPORADA_E_SEMANA_A_SEMANA_PARAM = "MARCAR_AMISTOSOS_INICIO_TEMPORADA_E_SEMANA_A_SEMANA";
