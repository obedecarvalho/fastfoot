...
public class ParametroConstantes {
	...
	public static final String METODO_CALCULO_PROBABILIDADE_ESTATISTICA_FINALIZACAO_POISSON_PARAM = "MET_CALC_PROB_ESTATISTICA_FINALIZACAO_POISSON_PARAM";
	
	public static final String METODO_CALCULO_PROBABILIDADE_ESTATISTICA_FINALIZACAO_PARAM = "MET_CALC_PROB_ESTATISTICA_FINALIZACAO_PARAM";
	
	public static final String METODO_CALCULO_PROBABILIDADE_ESTATISTICA_FINALIZACAO_DEFESA_PARAM = "MET_CALC_PROB_ESTATISTICA_FINALIZACAO_DEFESA_PARAM";
	
	public static final String METODO_CALCULO_PROBABILIDADE_SIMULAR_PARTIDA_PARAM = "MET_CALC_PROB_SIMULAR_PARTIDA_PARAM";
	
	public static final String METODO_CALCULO_PROBABILIDADE_SIMULAR_PARTIDA_HABILIDADE_GRUPO_PARAM = "MET_CALC_PROB_SIMULAR_PARTIDA_HABILIDADE_GRUPO_PARAM";
