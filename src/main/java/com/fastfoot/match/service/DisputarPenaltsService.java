...
public class DisputarPenaltsService {//TODO: Penalty e Penalties
	...
	/*public void disputarPenalts(PartidaResultadoJogavel partidaResultado, Esquema esquema) {
		...
		Collections.sort(jogadoresMandantes, JogadorFactory.getComparatorHabilidadeFinalizacao());
		Collections.sort(jogadoresVisitantes, JogadorFactory.getComparatorHabilidadeFinalizacao());
	...
	/*public void disputarPenaltsHabilidadeGrupo(PartidaResultadoJogavel partidaResultado, Esquema esquema) {
		...
		Collections.sort(jogadoresMandantes, JogadorFactory.getComparatorHabilidadeGrupoConclusao());
		Collections.sort(jogadoresVisitantes, JogadorFactory.getComparatorHabilidadeGrupoConclusao());
