...
public enum PremiacaoClassificacao {
	...
	static {
		...
		PREMIACAO_CONTINENTAL.put(CAMPEAO, 1d);
		PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_FINAL, 1d);
		PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_SEMI_FINAL, 1d);
		PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_QUARTAS_FINAL, 1d);
		//PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_OITAVAS_FINAL, 1d);
		PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_FASE_GRUPOS, 1d);
		//PREMIACAO_CONTINENTAL.put(CLASSIFICACAO_FASE_PRELIMINAR, 1d);
		
		PREMIACAO_CONTINENTAL_II.put(CAMPEAO, 1d);
		PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_FINAL, 1d);
		PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_SEMI_FINAL, 1d);
		PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_QUARTAS_FINAL, 1d);
		//PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_OITAVAS_FINAL, 1d);
		PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_FASE_GRUPOS, 1d);
		//PREMIACAO_CONTINENTAL_II.put(CLASSIFICACAO_FASE_PRELIMINAR, 1d);
		
		PREMIACAO_CONTINENTAL_III.put(CAMPEAO, 1d);
		PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_FINAL, 1d);
		PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_SEMI_FINAL, 1d);
		PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_QUARTAS_FINAL, 1d);
		//PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_OITAVAS_FINAL, 1d);
		PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_FASE_GRUPOS, 1d);
		//PREMIACAO_CONTINENTAL_III.put(CLASSIFICACAO_FASE_PRELIMINAR, 1d);
		
		PREMIACAO_COPA_NACIONAL.put(CAMPEAO, 1d);
		PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_FINAL, 1d);
		PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_SEMI_FINAL, 1d);
		PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_QUARTAS_FINAL, 1d);
		PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_OITAVAS_FINAL, 1d);
		//PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_FASE_GRUPOS, 1d);
		PREMIACAO_COPA_NACIONAL.put(CLASSIFICACAO_FASE_PRELIMINAR, 1d);
		
		PREMIACAO_COPA_NACIONAL_II.put(CAMPEAO, 1d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_FINAL, 1d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_SEMI_FINAL, 1d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_QUARTAS_FINAL, 1d);
