...
public enum PremiacaoClassificacao {
	...
	static {
		...
		PREMIACAO_COPA_NACIONAL_II.put(CAMPEAO, 2500000d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_FINAL, 1250000d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_SEMI_FINAL, 625000d);
		PREMIACAO_COPA_NACIONAL_II.put(CLASSIFICACAO_QUARTAS_FINAL, 625000d);
