...
public class CalcularPartidaProbabilidadeResultadoEstatisticaFinalizacaoService {
	...
	public CompletableFuture<Boolean> simularPartidas(RodadaJogavel rodada) {
		...
		/*List<Map<String, Object>> estatisticasFinalizacoes = jogadorEstatisticasTemporadaRepository
				.findEstatisticasFinalizacoesPorClube(rodada.getSemana().getTemporada().getId());
		...
		/*List<Map<String, Object>> estatisticasDefesa = jogadorEstatisticasTemporadaRepository
				.findEstatisticasDefesaPorClube(rodada.getSemana().getTemporada().getId());
	...
	public PartidaProbabilidadeResultado simularPartida(PartidaResultadoJogavel partidaResultado,
		...
		partidaProbabilidadeResultado
				.setTipoProbabilidadeResultadoPartida(TipoProbabilidadeResultadoPartida.ESTATISTICAS_DEFESA);
