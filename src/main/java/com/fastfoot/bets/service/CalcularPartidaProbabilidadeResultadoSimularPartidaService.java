...
@Service
public class CalcularPartidaProbabilidadeResultadoSimularPartidaService extends CalcularPartidaProbabilidadeResultadoSimularPartidaAbstractService {//TODO: renomear para CalcularPartidaProbabilidadeResultadoSimularPartidaHabilidadeService
	...
	/*public PartidaProbabilidadeResultado calcularPartidaProbabilidadeResultado(PartidaResultadoJogavel partidaResultado, EscalacaoClube escalacaoMandante, EscalacaoClube escalacaoVisitante) {
		...
		for (int i = 0; i < NUM_SIMULACOES; i++) {
			...
			jogar(esquema, partidaResultado, false);
