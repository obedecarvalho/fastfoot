...
public class JogadorMeiaFactory extends JogadorFactory {
	...
	private static JogadorMeiaFactory INSTANCE;
	
	protected JogadorMeiaFactory() {

	}
	
	public static JogadorMeiaFactory getInstance() {
		if (INSTANCE == null) {
			INSTANCE = new JogadorMeiaFactory();
		}
		return INSTANCE;
	}
