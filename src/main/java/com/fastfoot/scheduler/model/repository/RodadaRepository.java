...
public interface RodadaRepository extends JpaRepository<Rodada, Long>{
	...
	public List<Rodada> findByCampeonatoAndNumero(@Param("campeonato") Campeonato campeonato,
			@Param("numero") Integer numero);
	
	@Query("SELECT r FROM Rodada r WHERE r.grupoCampeonato IN :gruposCampeonato AND r.numero = :numero ")
	public List<Rodada> findByGruposCampeonatoAndNumero(
			@Param("gruposCampeonato") List<GrupoCampeonato> grupoCampeonato, @Param("numero") Integer numero);
