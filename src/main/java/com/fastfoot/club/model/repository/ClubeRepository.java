...
public interface ClubeRepository extends JpaRepository<Clube, Integer>{
	...
	public List<Clube> findByLigaAndAnoAndClassificacaoNacionalBetween(@Param("liga") Liga liga, @Param("ano") Integer ano, @Param("classNac") ClassificacaoNacional[] classNac);
}
