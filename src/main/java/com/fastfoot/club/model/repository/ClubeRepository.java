...
public interface ClubeRepository extends JpaRepository<Clube, Integer>{
	...
	public List<Clube> findByLigaAndAnoAndPosicaoGeralBetween(@Param("liga") Liga liga, @Param("ano") Integer ano,
	...
	public List<Clube> findByLigaAndAnoAndClassificacaoNacionalBetween(@Param("liga") Liga liga,
