...
public class PreCarregarClubeService {
	...
	private void inserirClubes() {
		...
		if (clubeRepository.findAll().size() == 0) {
			...
			clubes.add(new Clube(501, Liga.BRASIL, 85, "Palmeiras"));
			clubes.add(new Clube(502, Liga.BRASIL, 85, "Atlético"));
			clubes.add(new Clube(503, Liga.BRASIL, 82, "Flamengo"));
			clubes.add(new Clube(504, Liga.BRASIL, 82, "Athlético"));
			clubes.add(new Clube(505, Liga.BRASIL, 82, "Corinthians"));			
			clubes.add(new Clube(506, Liga.BRASIL, 78, "Santos"));
			clubes.add(new Clube(507, Liga.BRASIL, 78, "Fluminense"));
			clubes.add(new Clube(508, Liga.BRASIL, 78, "Internacional"));
			clubes.add(new Clube(509, Liga.BRASIL, 78, "São Paulo"));
			clubes.add(new Clube(510, Liga.BRASIL, 75, "Fortaleza"));
			clubes.add(new Clube(511, Liga.BRASIL, 75, "Botafogo"));
			clubes.add(new Clube(512, Liga.BRASIL, 75, "Ceará"));
			clubes.add(new Clube(513, Liga.BRASIL, 75, "América"));
			clubes.add(new Clube(514, Liga.BRASIL, 75, "Red Bull Bragantino"));
			clubes.add(new Clube(515, Liga.BRASIL, 71, "Bahia"));
			clubes.add(new Clube(516, Liga.BRASIL, 71, "Atlético - GO"));
			clubes.add(new Clube(517, Liga.BRASIL, 71, "Goiás"));
			clubes.add(new Clube(518, Liga.BRASIL, 71, "Cuiabá"));
			clubes.add(new Clube(519, Liga.BRASIL, 71, "Cruzeiro"));
			clubes.add(new Clube(520, Liga.BRASIL, 71, "Grêmio"));
