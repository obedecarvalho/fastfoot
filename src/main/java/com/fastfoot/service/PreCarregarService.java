...
public class PreCarregarService {
	...
	private void inserirClubes() {
		...
		if (clubeRepository.findAll().size() == 0) {
			...
			clubes.add(new Clube(101, Liga.GENEBE, 85, "Bayern München"));
			clubes.add(new Clube(102, Liga.GENEBE, 85, "Ajax"));
			clubes.add(new Clube(103, Liga.GENEBE, 82, "Borussia Dortmund"));
			clubes.add(new Clube(104, Liga.GENEBE, 82, "Bayer Leverkusen"));
			clubes.add(new Clube(105, Liga.GENEBE, 82, "PSV"));
			clubes.add(new Clube(106, Liga.GENEBE, 78, "RB Leipzig"));
			clubes.add(new Clube(107, Liga.GENEBE, 78, "Feyenoord"));
			clubes.add(new Clube(108, Liga.GENEBE, 78, "Borussia Mönchengladbach"));
			clubes.add(new Clube(109, Liga.GENEBE, 78, "Club Brugge"));
			clubes.add(new Clube(110, Liga.GENEBE, 75, "Eintracht Frankfurt"));
			clubes.add(new Clube(111, Liga.GENEBE, 75, "Freiburg"));
			clubes.add(new Clube(112, Liga.GENEBE, 75, "Union Berlin"));
			clubes.add(new Clube(113, Liga.GENEBE, 75, "Wolfsburg"));
			clubes.add(new Clube(114, Liga.GENEBE, 75, "AZ Alkmaar"));
			clubes.add(new Clube(115, Liga.GENEBE, 71, "Hoffenheim"));
			clubes.add(new Clube(116, Liga.GENEBE, 71, "Mainz 05"));
			clubes.add(new Clube(117, Liga.GENEBE, 71, "Colônia"));
			clubes.add(new Clube(118, Liga.GENEBE, 71, "Utrecht"));
			clubes.add(new Clube(119, Liga.GENEBE, 71, "Hertha Berlin"));
			clubes.add(new Clube(120, Liga.GENEBE, 71, "VfB Stuttgart"));
			clubes.add(new Clube(121, Liga.GENEBE, 68, "Vitesse"));
			clubes.add(new Clube(122, Liga.GENEBE, 68, "Fortuna Düsseldorf"));
			clubes.add(new Clube(123, Liga.GENEBE, 68, "Hamburgo"));
			clubes.add(new Clube(124, Liga.GENEBE, 68, "Ingolstadt"));
			clubes.add(new Clube(125, Liga.GENEBE, 68, "Gent"));
			clubes.add(new Clube(126, Liga.GENEBE, 68, "Antwerp"));
			clubes.add(new Clube(127, Liga.GENEBE, 64, "Arminia Bielefeld"));
			clubes.add(new Clube(128, Liga.GENEBE, 64, "Augsburg"));
			clubes.add(new Clube(129, Liga.GENEBE, 64, "Anderlecht"));
			clubes.add(new Clube(130, Liga.GENEBE, 64, "Bochum"));
			clubes.add(new Clube(131, Liga.GENEBE, 64, "Racing Genk"));
			clubes.add(new Clube(132, Liga.GENEBE, 64, "Werder Bremen"));
			clubes.add(new Clube(201, Liga.SPAPOR, 85, "Real Madrid"));
			clubes.add(new Clube(202, Liga.SPAPOR, 85, "Barcelona"));
			clubes.add(new Clube(203, Liga.SPAPOR, 82, "Porto"));
			clubes.add(new Clube(204, Liga.SPAPOR, 82, "Atlético Madrid"));
			clubes.add(new Clube(205, Liga.SPAPOR, 82, "Benfica"));
			clubes.add(new Clube(206, Liga.SPAPOR, 78, "Sevilla"));
			clubes.add(new Clube(207, Liga.SPAPOR, 78, "Sporting"));
			clubes.add(new Clube(208, Liga.SPAPOR, 78, "Real Betis"));
			clubes.add(new Clube(209, Liga.SPAPOR, 78, "Valencia"));
			clubes.add(new Clube(210, Liga.SPAPOR, 75, "Real Sociedad"));
			clubes.add(new Clube(211, Liga.SPAPOR, 75, "Villarreal"));
			clubes.add(new Clube(212, Liga.SPAPOR, 75, "Athletic Bilbao"));
			clubes.add(new Clube(213, Liga.SPAPOR, 75, "Braga"));
			clubes.add(new Clube(214, Liga.SPAPOR, 75, "Celta de Vigo"));
			clubes.add(new Clube(215, Liga.SPAPOR, 71, "Rayo Vallecano"));
			clubes.add(new Clube(216, Liga.SPAPOR, 71, "Osasuna"));
			clubes.add(new Clube(217, Liga.SPAPOR, 71, "Leganes"));
			clubes.add(new Clube(218, Liga.SPAPOR, 71, "Granada"));
			clubes.add(new Clube(219, Liga.SPAPOR, 71, "Espanyol"));
			clubes.add(new Clube(220, Liga.SPAPOR, 71, "Mallorca"));
			clubes.add(new Clube(221, Liga.SPAPOR, 68, "Huesca"));
			clubes.add(new Clube(222, Liga.SPAPOR, 68, "Alaves"));
			clubes.add(new Clube(223, Liga.SPAPOR, 68, "Elche"));
			clubes.add(new Clube(224, Liga.SPAPOR, 68, "Getafe"));
			clubes.add(new Clube(225, Liga.SPAPOR, 68, "Girona"));
			clubes.add(new Clube(226, Liga.SPAPOR, 68, "Eibar"));
			clubes.add(new Clube(227, Liga.SPAPOR, 64, "Real Valladolid"));
			clubes.add(new Clube(228, Liga.SPAPOR, 64, "Sporting Gijón"));
			clubes.add(new Clube(229, Liga.SPAPOR, 64, "Levante"));
			clubes.add(new Clube(230, Liga.SPAPOR, 64, "Cádiz"));
			clubes.add(new Clube(231, Liga.SPAPOR, 64, "Zaragoza"));
			clubes.add(new Clube(232, Liga.SPAPOR, 64, "Málaga"));
			clubes.add(new Clube(301, Liga.ITAFRA, 85, "Internazionale" /*"Inter Milan"*/));
			clubes.add(new Clube(302, Liga.ITAFRA, 85, "Juventus"));
			clubes.add(new Clube(303, Liga.ITAFRA, 82, "Paris Saint-Germain"));
			clubes.add(new Clube(304, Liga.ITAFRA, 82, "Napoli"));
			clubes.add(new Clube(305, Liga.ITAFRA, 82, "Milan"));
			clubes.add(new Clube(306, Liga.ITAFRA, 78, "Atalanta"));
			clubes.add(new Clube(307, Liga.ITAFRA, 78, "Lille"));
			clubes.add(new Clube(308, Liga.ITAFRA, 78, "Lazio"));
			clubes.add(new Clube(309, Liga.ITAFRA, 78, "Lyon"));
			clubes.add(new Clube(310, Liga.ITAFRA, 75, "Roma"));
			clubes.add(new Clube(311, Liga.ITAFRA, 75, "Olympique de Marseille"));
			clubes.add(new Clube(312, Liga.ITAFRA, 75, "Monaco"));
			clubes.add(new Clube(313, Liga.ITAFRA, 75, "Fiorentina"));
			clubes.add(new Clube(314, Liga.ITAFRA, 75, "Sassuolo"));
			clubes.add(new Clube(315, Liga.ITAFRA, 71, "Rennes"));
			clubes.add(new Clube(316, Liga.ITAFRA, 71, "Verona"));
			clubes.add(new Clube(317, Liga.ITAFRA, 71, "RC Strasbourg"));
			clubes.add(new Clube(318, Liga.ITAFRA, 71, "Montpellier"));
			clubes.add(new Clube(319, Liga.ITAFRA, 71, "Bologna"));
			clubes.add(new Clube(320, Liga.ITAFRA, 71, "Nice"));
			clubes.add(new Clube(321, Liga.ITAFRA, 68, "Lens"));
			clubes.add(new Clube(322, Liga.ITAFRA, 68, "Torino"));
			clubes.add(new Clube(323, Liga.ITAFRA, 68, "Udinese"));
			clubes.add(new Clube(324, Liga.ITAFRA, 68, "Empoli"));
			clubes.add(new Clube(325, Liga.ITAFRA, 68, "Sampdoria"));
			clubes.add(new Clube(326, Liga.ITAFRA, 68, "Stade Brestois"));
			clubes.add(new Clube(327, Liga.ITAFRA, 64, "Nantes"));
			clubes.add(new Clube(328, Liga.ITAFRA, 64, "Carpi"));
			clubes.add(new Clube(329, Liga.ITAFRA, 64, "Angers"));
			clubes.add(new Clube(330, Liga.ITAFRA, 64, "Reims"));
			clubes.add(new Clube(331, Liga.ITAFRA, 64, "Genoa"));
			clubes.add(new Clube(332, Liga.ITAFRA, 64, "Venezia"));
			clubes.add(new Clube(401, Liga.ENGLND, 85, "Liverpool"));
			clubes.add(new Clube(402, Liga.ENGLND, 85, "Manchester United"));
			clubes.add(new Clube(403, Liga.ENGLND, 82, "Manchester City"));
			clubes.add(new Clube(404, Liga.ENGLND, 82, "Chelsea"));
			clubes.add(new Clube(405, Liga.ENGLND, 82, "Arsenal"));
			clubes.add(new Clube(406, Liga.ENGLND, 78, "West Ham"));
			clubes.add(new Clube(407, Liga.ENGLND, 78, "Tottenham"));
			clubes.add(new Clube(408, Liga.ENGLND, 78, "Leicester City"));
			clubes.add(new Clube(409, Liga.ENGLND, 78, "Rangers"));
			clubes.add(new Clube(410, Liga.ENGLND, 75, "Aston Villa"));
			clubes.add(new Clube(411, Liga.ENGLND, 75, /*"Wolverhampton Wanderers"*/ "Wolves"));
			clubes.add(new Clube(412, Liga.ENGLND, 75, "Crystal Palace"));
			clubes.add(new Clube(413, Liga.ENGLND, 75, "Everton"));
			clubes.add(new Clube(414, Liga.ENGLND, 75, "Celtic"));
			clubes.add(new Clube(415, Liga.ENGLND, 71, "Leeds United"));
			clubes.add(new Clube(416, Liga.ENGLND, 71, "Brighton"));
			clubes.add(new Clube(417, Liga.ENGLND, 71, "Southampton"));
			clubes.add(new Clube(418, Liga.ENGLND, 71, "Burnley"));
			clubes.add(new Clube(419, Liga.ENGLND, 71, "Watford"));
			clubes.add(new Clube(420, Liga.ENGLND, 71, "Newcastle"));
			clubes.add(new Clube(421, Liga.ENGLND, 68, "Aberdeen"));
			clubes.add(new Clube(422, Liga.ENGLND, 68, "Brentford"));
			clubes.add(new Clube(423, Liga.ENGLND, 68, "Fulham"));
			clubes.add(new Clube(424, Liga.ENGLND, 68, "Bournemouth"));
			clubes.add(new Clube(425, Liga.ENGLND, 68, "Sheffield United"));
			clubes.add(new Clube(426, Liga.ENGLND, 68, "Blackburn Rovers"));
			clubes.add(new Clube(427, Liga.ENGLND, 64, "Motherwell"));
			clubes.add(new Clube(428, Liga.ENGLND, 64, "Hull City"));
			clubes.add(new Clube(429, Liga.ENGLND, 64, "Stoke City"));
			clubes.add(new Clube(430, Liga.ENGLND, 64, "Swansea City"));
			clubes.add(new Clube(431, Liga.ENGLND, 64, "West Bromwich"));
			clubes.add(new Clube(432, Liga.ENGLND, 64, "Blackpool"));
